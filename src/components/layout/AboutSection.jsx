  ...
  return (
    <section className="mx-auto mt-12 max-w-6xl rounded-[32px] border border-white/60 bg-white/90 px-6 py-10 text-center shadow-card">
      ...
      <p className="mx-auto mt-3 max-w-3xl text-secondary-600">
        We blend ingredient recognition, curated substitution science, and a dash of retro charm to help
        every pantry turn into a five-star kitchen. Built by Kedar Mashalkar for food lovers everywhere.
      </p>
